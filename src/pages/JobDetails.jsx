  ...
  return (
    <div className="min-h-screen bg-[#F4F7FC] py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {}
        <Link to="/jobs" className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-500 hover:text-[#0066FF] transition">
        ...
        <div className="bg-white border border-[#0066FF]/20 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 border-b border-slate-100 pb-6">
            ...
            <span className="self-start px-3 py-1 rounded-full bg-[#003366] text-white text-xs font-bold shadow-sm">
          ...
          <div className="space-y-2">
            <h3 className="text-sm font-bold text-[#003366]">Job Description</h3>
          ...
          <div className="pt-4 border-t border-slate-100">
            {isExpired ? (
              ...
              <p className="text-xs text-slate-455 font-bold italic">
