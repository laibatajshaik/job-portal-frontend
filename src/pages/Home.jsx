  ...
  return (
    <div className="min-h-screen bg-[#F4F7FC] text-slate-800 font-sans pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        ...
        {/* HERO / SEARCH SECTION WITH ROYAL BLUE GRADIENT */}
        <section className="bg-gradient-to-br from-[#0066FF] to-[#003366] text-white rounded-[36px] py-20 px-6 sm:px-12 text-center relative overflow-hidden shadow-xl shadow-[#003366]/10">
          ...
          <div className="relative z-10 space-y-6 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black tracking-tight leading-tight text-white uppercase">
              Find your next <br />
              <span className="text-[#0066FF] bg-white px-3 py-1 rounded-2xl font-black text-3xl sm:text-5xl mt-2 inline-block">
                Dream Career
              </span>
            </h1>
        ...
        <section className="mt-16 max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8 border-b border-slate-200/50 pb-4">
            ...
            <Link 
              to="/jobs" 
              className="text-xs font-bold text-[#0066FF] hover:text-[#0052CC] flex items-center gap-1 bg-[#0066FF]/5 border border-[#0066FF]/15 px-4 py-2.5 rounded-full transition shadow-sm"
            >
