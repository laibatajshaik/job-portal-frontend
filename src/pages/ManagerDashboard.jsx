                    ...
                    >
                      <div className="space-y-2">
                        <div>
                          ...
                          <div className="flex items-center gap-3 text-[11px] text-slate-555 font-semibold mt-0.5">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {jobs.map(job => (
                      <tr key={job.id} className="hover:bg-slate-50/50">
                        ...
                        <td className="p-3 text-slate-655">{job.location}</td>
                        <td className="p-3 text-slate-655">{job.salary}</td>
