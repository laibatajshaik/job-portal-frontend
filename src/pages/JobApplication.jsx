  ...
  return (
    <div className="min-h-screen bg-[#F4F7FC] py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-xl mx-auto space-y-6">
        ...
        {}
        <Link to={`/jobs/${id}`} className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-500 hover:text-[#0066FF] transition">
        ...
        <div className="bg-white border border-[#0066FF]/20 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
          ...
          <div className="border-b border-slate-100 pb-4">
            <h1 className="text-2xl font-bold text-[#003366]">Apply for Job</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#F4F7FC]/50 border border-[#0066FF]/25 focus:border-[#0066FF] rounded-xl px-4 py-2.5 text-xs text-slate-900 font-bold outline-none transition"
                required
              />
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-[#003366] hover:bg-[#002244] text-white font-extrabold text-xs py-3.5 rounded-xl shadow-md transition mt-2 uppercase tracking-wider"
            >
