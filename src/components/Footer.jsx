    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800 pt-12 pb-8 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white tracking-tight">
                Job<span className="text-indigo-400">Spark</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 text-slate-400 pt-1">
              <a href="#" className="p-2 rounded-lg bg-slate-800 border border-slate-700 hover:text-white transition" title="Website">
                <Globe className="w-4 h-4" />
              </a>
              <a href="#" className="p-2 rounded-lg bg-slate-800 border border-slate-700 hover:text-white transition" title="Code">
                <Code2 className="w-4 h-4" />
              </a>
              <a href="#" className="p-2 rounded-lg bg-slate-800 border border-slate-700 hover:text-white transition" title="Social">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-wider mb-3">For Candidates</h4>
          ...
          {/* Employers */}
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-wider mb-3">For Employers</h4>
            <ul className="space-y-2 text-xs">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400">Get job alerts delivered directly to your inbox.</p>
            <div className="flex gap-2">
              <input 
                type="email" 
                placeholder="Enter email address" 
                className="bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 flex-1"
              />
              <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-2 rounded-lg text-xs font-semibold transition">
                Join
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4">
          ...
          <div className="flex items-center gap-1">
            <span>Clean & Powerful Career Platform</span>
          </div>
        </div>
      </div>
    </footer>
